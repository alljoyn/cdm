...
/**
 * OnControl Interface Controllee Listener class
 */
class OnControlIntfControlleeListener : public InterfaceControlleeListener {
  public:
    /**
     * Destructor of OnControlIntfControlleeListener
     */
    virtual ~OnControlIntfControlleeListener() {}
     ...
     */
     virtual QStatus OnSwitchOn(ErrorCode& errorCode) = 0;
};
