...
class LaundryCyclePhaseIntfControllerListener : public InterfaceControllerListener {
  public:
     ...
     */
    virtual void OnResponseGetVendorPhasesDescription(QStatus status, const qcc::String& objectPath, const LaundryCyclePhaseInterface::CyclePhaseDescriptions& listOfCycleDescriptions,
