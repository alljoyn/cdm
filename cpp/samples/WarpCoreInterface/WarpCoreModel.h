...
#include "controllee/WarpCoreIntfControlleeModel.h"
#include "../Utils/Command.h"


class WarpCoreModel : public virtual ajn::services::WarpCoreIntfControlleeModel {
  public:
     ...
     * @return ER_OK on success
     */
    QStatus Engage(ajn::services::ErrorCode& error, ajn::services::CdmControllee& controllee) override;
    /**
     * Handler for method Disengage
     * @param[out] error Internal error code occurred during command execution
     * @return ER_OK on success
     */
    QStatus Disengage(ajn::services::ErrorCode& error, ajn::services::CdmControllee& controllee) override;
...
QStatus HandleWarpCoreCommand(const ajn::services::Command& cmd, ajn::services::CdmControllee& controllee);
