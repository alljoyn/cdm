...
class org_alljoyn_SmartSpaces_Operation_LaundryCyclePhase : public QWidget, public ajn::services::LaundryCyclePhaseIntfControllerListener
{
    Q_OBJECT
public:
...
private:
    ajn::services::LaundryCyclePhaseIntfControllerPtr controller;
