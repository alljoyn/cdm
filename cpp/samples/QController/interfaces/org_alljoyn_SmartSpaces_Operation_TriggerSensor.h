...
#ifndef org_alljoyn_SmartSpaces_Operation_TriggerSensor_H_
#define org_alljoyn_SmartSpaces_Operation_TriggerSensor_H_
...
class org_alljoyn_SmartSpaces_Operation_TriggerSensor : public QWidget
{
    Q_OBJECT
public:
    Q_INVOKABLE org_alljoyn_SmartSpaces_Operation_TriggerSensor(CommonControllerInterface *iface=NULL);
    ~org_alljoyn_SmartSpaces_Operation_TriggerSensor();

    // Slots mirror the callbacks to avoid threading issues
private slots:

    void slotOnResponseGetCurrentlyTriggered(QStatus status, const bool value);
    void slotOnCurrentlyTriggeredChanged(const bool value);
...
public:
    ...
    public:
        ...
        {
            qWarning() << "TriggerSensor::OnResponseGetCurrentlyTriggered";
        ...
        {
            qWarning() << "TriggerSensor::OnCurrentlyTriggeredChanged";
...
private:
    ...
    QCheckBox* edit_CurrentlyTriggered;
...
#endif /* org_alljoyn_SmartSpaces_Operation_TriggerSensor_H_ */
