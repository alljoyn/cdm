...
private slots:
    ...
    void slotOnResponseGetAlerts(QStatus status, const std::vector<AlertsInterface::AlertRecord>& value);
    void slotOnAlertsChanged(const std::vector<AlertsInterface::AlertRecord>& value);
    void slotOnResponseMethodGetAlertCodesDescription(QStatus status, const std::vector<AlertsInterface::AlertCodesDescriptor>& description, const QString& errorName);
...
public:
    ...
    public:
        ...
        {
            qWarning() << "Alerts::OnResponseGetAlerts";
        ...
        {
            qWarning() << "Alerts::OnAlertsChanged";
        ...
        {
            qWarning() << "Alerts::OnResponseGetAlertCodesDescription";
            QMetaObject::invokeMethod(m_widget, "slotOnResponseMethodGetAlertCodesDescription", Qt::QueuedConnection,
                              Q_ARG(QStatus, status), Q_ARG(std::vector<AlertsInterface::AlertCodesDescriptor>, description), Q_ARG(QString, QString(errorName))
                              );
        }
        ...
        {
            qWarning() << "Alerts::OnResponseAcknowledgeAlert";
        ...
        {
            qWarning() << "Alerts::OnResponseAcknowledgeAllAlerts";
