...
#ifndef org_alljoyn_SmartSpaces_Operation_OnOffStatus_H_
#define org_alljoyn_SmartSpaces_Operation_OnOffStatus_H_
...
class org_alljoyn_SmartSpaces_Operation_OnOffStatus : public QWidget
{
    Q_OBJECT
public:
    Q_INVOKABLE org_alljoyn_SmartSpaces_Operation_OnOffStatus(CommonControllerInterface *iface=NULL);
    ~org_alljoyn_SmartSpaces_Operation_OnOffStatus();

    // Slots mirror the callbacks to avoid threading issues
private slots:

    void slotOnResponseGetIsOn(QStatus status, const bool value);
    void slotOnIsOnChanged(const bool value);
...
public:
    ...
    public:
        ...
        {
            qWarning() << "OnOffStatus::OnResponseGetIsOn";
        ...
        {
            qWarning() << "OnOffStatus::OnIsOnChanged";
...
#endif /* org_alljoyn_SmartSpaces_Operation_OnOffStatus_H_ */
