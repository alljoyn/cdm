...
#ifndef org_alljoyn_SmartSpaces_Operation_OvenCyclePhase_H_
#define org_alljoyn_SmartSpaces_Operation_OvenCyclePhase_H_
...
class org_alljoyn_SmartSpaces_Operation_OvenCyclePhase : public QWidget
{
    Q_OBJECT
public:
    Q_INVOKABLE org_alljoyn_SmartSpaces_Operation_OvenCyclePhase(CommonControllerInterface *iface=NULL);
    ~org_alljoyn_SmartSpaces_Operation_OvenCyclePhase();
...
private slots:
    ...
    void slotOnResponseMethodGetVendorPhasesDescription(QStatus status, const std::vector<OvenCyclePhaseInterface::CyclePhaseDescriptor>& phasesDescription, const QString& errorName);

public:
    // ajn::services::OvenCyclePhaseIntfControllerListener
    class Listener: public ajn::services::OvenCyclePhaseIntfControllerListener
    {
    public:
        QWidget* m_widget;
        ...
        {
            qWarning() << "OvenCyclePhase::OnResponseGetCyclePhase";
        ...
        {
            qWarning() << "OvenCyclePhase::OnCyclePhaseChanged";
        ...
        {
            qWarning() << "OvenCyclePhase::OnResponseGetSupportedCyclePhases";
        ...
        {
            qWarning() << "OvenCyclePhase::OnSupportedCyclePhasesChanged";
            QMetaObject::invokeMethod(m_widget, "slotOnSupportedCyclePhasesChanged", Qt::QueuedConnection,
                              Q_ARG(std::vector<uint8_t>, value)
                              );
        }
        virtual void OnResponseGetVendorPhasesDescription(QStatus status, const qcc::String& objectPath, const std::vector<OvenCyclePhaseInterface::CyclePhaseDescriptor>& phasesDescription, void* context, const char* errorName, const char* errorMessage) override
        {
            qWarning() << "OvenCyclePhase::OnResponseGetVendorPhasesDescription";
            QMetaObject::invokeMethod(m_widget, "slotOnResponseMethodGetVendorPhasesDescription", Qt::QueuedConnection,
                              Q_ARG(QStatus, status), Q_ARG(std::vector<OvenCyclePhaseInterface::CyclePhaseDescriptor>, phasesDescription), Q_ARG(QString, QString(errorName))
                              );
        }
    };

private:
    Ref<ajn::services::OvenCyclePhaseIntfController> controller;
...
#endif /* org_alljoyn_SmartSpaces_Operation_OvenCyclePhase_H_ */
