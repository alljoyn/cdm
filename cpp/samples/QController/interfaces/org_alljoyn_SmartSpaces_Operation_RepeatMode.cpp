...
org_alljoyn_SmartSpaces_Operation_RepeatMode::org_alljoyn_SmartSpaces_Operation_RepeatMode(CommonControllerInterface *iface) : controller(NULL)
{
    ...
    if (iface)
    {
        controller = iface->CreateInterface<RepeatModeIntfController>(*this);
        if (controller)
        {
