...
class org_alljoyn_SmartSpaces_Operation_SoilLevel : public QWidget, public ajn::services::SoilLevelIntfControllerListener
{
    Q_OBJECT
public:
...
private:
    ajn::services::SoilLevelIntfControllerPtr controller;
