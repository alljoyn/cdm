...
CdmInterface* VendorDefinedIntfControllerImpl::CreateInterface(BusAttachment& busAttachment, InterfaceControllerListener& listener, ProxyBusObject& cdmProxyObject)
{
...
VendorDefinedIntfControllerImpl::VendorDefinedIntfControllerImpl(BusAttachment& busAttachment, VendorDefinedIntfControllerListener& listener, ProxyBusObject& cdmProxyObject) :
