...
class EnergyUsageModel : public virtual EnergyUsageIntfControlleeModel {
  public:
    EnergyUsageModel(const std::string& busPath);

    /**
     * Get CumulativeEnergy
     * @return current cumulative energy
     */
    QStatus GetCumulativeEnergy(double& out) const override;
