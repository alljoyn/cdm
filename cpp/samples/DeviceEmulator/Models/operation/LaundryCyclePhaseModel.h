...
class LaundryCyclePhaseModel : public virtual LaundryCyclePhaseIntfControlleeModel {
  public:
    LaundryCyclePhaseModel(const std::string& busPath);
     ...
     */
    QStatus GetVendorPhasesDescription(qcc::String& arg_languageTag, std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>& arg_phasesDescription, ErrorCode& error, CdmControllee& controllee) override;
