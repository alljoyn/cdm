...
class OffControlModel : public virtual OffControlIntfControlleeModel {
  public:
    OffControlModel(const std::string& busPath);
     ...
     */
    QStatus SwitchOff(ErrorCode& error, CdmSideEffects& sideEffects) override;
