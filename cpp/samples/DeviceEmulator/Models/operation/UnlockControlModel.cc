...
UnlockControlModel::UnlockControlModel(const std::string& busPath) :
    m_busPath(busPath)
{}

QStatus UnlockControlModel::Unlock(ErrorCode& error, CdmSideEffects& sideEffects)
{
    bool value = false;
