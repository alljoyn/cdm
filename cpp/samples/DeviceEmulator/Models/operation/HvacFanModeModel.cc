...
template <>
struct Serializer<HvacFanModeInterface::Mode>
{
    Element* put(Element* parent, HvacFanModeInterface::Mode value)
    {
    ...
    HvacFanModeInterface::Mode get(Element* element)
    {
        Serializer<int32_t> ser;
        return static_cast<HvacFanModeInterface::Mode>(ser.get(element));
    }
};
...
HvacFanModeModel::HvacFanModeModel(const std::string& busPath) :
    m_busPath(busPath)
{}
