...
class CurrentAirQualityModel : public virtual CurrentAirQualityIntfControlleeModel {
  public:
    CurrentAirQualityModel(const std::string& busPath);

    /**
     * Get ContaminantType
     * @return current contaminant type
     */
    QStatus GetContaminantType(CurrentAirQualityInterface::ContaminantType& out) const override;
