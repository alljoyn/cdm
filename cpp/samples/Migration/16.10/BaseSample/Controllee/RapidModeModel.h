...
class RapidModeModel : public RapidModeIntfControlleeModel
{
  public:
    RapidModeModel();

    virtual QStatus SetRapidMode(const bool rapidMode) override;

    virtual QStatus GetRapidMode(bool& rapidMode) const override;
