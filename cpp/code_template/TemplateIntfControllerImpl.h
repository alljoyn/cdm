...
#include <alljoyn/hae/interfaces/{interface_category}/{interface_name}IntfController.h>
...
class {interface_name}IntfControllerImpl : public InterfaceController, public {interface_name}IntfController {
  public:
     ...
     */
    {interface_name}IntfControllerImpl(BusAttachment& busAttachment, {interface_name}IntfControllerListener& listener, HaeProxyBusObject& haeProxyObject);
