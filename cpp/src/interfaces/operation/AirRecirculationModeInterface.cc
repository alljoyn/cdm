...
"        <description language='en'>This interface provides capabilities to control switching the ventillation mode between recirculating and refreshing (exchanging air with outside on inlet or exhaust).</description>"
...
"            <description language='en'>If true, air is being recirculated</description>"
"            <annotation name='org.freedesktop.DBus.Property.EmitsChangedSignal' value='true'/>"
"        </property>"
"    </interface>"
"</node>"
