...
class RobotCleaningCyclePhaseIntfControlleeImpl : public InterfaceControllee, public RobotCleaningCyclePhaseIntfControllee {
  public:
     ...
     */
    RobotCleaningCyclePhaseIntfControlleeImpl(BusAttachment& busAttachment, RobotCleaningCyclePhaseIntfControlleeListener& listener, HaeBusObject& haeBusObject);
