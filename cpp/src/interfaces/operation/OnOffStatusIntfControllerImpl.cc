...
HaeInterface* OnOffStatusIntfControllerImpl::CreateInterface(BusAttachment& busAttachment, InterfaceControllerListener& listener, HaeProxyBusObject& haeProxyObject)
{
    return new OnOffStatusIntfControllerImpl(busAttachment, dynamic_cast<OnOffStatusIntfControllerListener&>(listener), haeProxyObject);
}

OnOffStatusIntfControllerImpl::OnOffStatusIntfControllerImpl(BusAttachment& busAttachment, OnOffStatusIntfControllerListener& listener, HaeProxyBusObject& haeProxyObject) :
