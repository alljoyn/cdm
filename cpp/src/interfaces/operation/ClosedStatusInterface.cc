...
"        <description language='en'>This interface provides the status of an opening.  It can be a stand alone door or window, or part of a larger object that might have multiple doors.  For example a refrigerator compartment door or oven door.</description>"
...
"        </property>"
"        <property name='IsClosed' type='b' access='readwrite'>"
"            <description language='en'>Boolean property that is true when object is closed.</description>"
"            <annotation name='org.freedesktop.DBus.Property.EmitsChangedSignal' value='true'/>"
"        </property>"
"    </interface>"
"</node>"
