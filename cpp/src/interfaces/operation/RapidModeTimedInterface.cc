...
const char* const RapidModeTimedInterface::INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.RapidModeTimed";
const CdmInterfaceType RapidModeTimedInterface::INTERFACE_TYPE = RAPID_MODE_TIMED_INTERFACE;
