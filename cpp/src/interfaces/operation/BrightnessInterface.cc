...
const char* const BrightnessInterface::INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.Brightness";
const CdmInterfaceType BrightnessInterface::INTERFACE_TYPE = BRIGHTNESS_INTERFACE;


const uint16_t BrightnessInterface::s_interfaceVersion = 1;

const qcc::String BrightnessInterface::s_xml =
...
const qcc::String BrightnessInterface::s_prop_Version = "Version";
const qcc::String BrightnessInterface::s_prop_Brightness = "Brightness";
