...
"        </property>"
"        <annotation name='org.alljoyn.Bus.Enum.ContaminantType.Value.CH20' value='0'/>"
"        <annotation name='org.alljoyn.Bus.Enum.ContaminantType.Value.CO2' value='1'/>"
"        <annotation name='org.alljoyn.Bus.Enum.ContaminantType.Value.C0' value='2'/>"
...
"            <annotation name='org.alljoyn.Bus.DocString.En' value='The precision of the CurrentValue property. i.e. the number of ug/m3 or ppm the actual power consumption must change before CurrentValue is updated.'/>"
"            <annotation name='org.freedesktop.DBus.Property.EmitsChangedSignal' value='true'/>"
"        </property>"
