...
const qcc::String TargetHumidityInterface::s_prop_MinValue = "MinValue";
const qcc::String TargetHumidityInterface::s_prop_MaxValue = "MaxValue";
const qcc::String TargetHumidityInterface::s_prop_StepValue = "StepValue";
const qcc::String TargetHumidityInterface::s_prop_SelectableHumidityLevels = "SelectableHumidityLevels";
