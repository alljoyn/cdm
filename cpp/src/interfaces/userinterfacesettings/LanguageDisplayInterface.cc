...
const qcc::String LanguageDisplayInterface::s_prop_Version = "Version";
const qcc::String LanguageDisplayInterface::s_prop_DisplayLanguage = "DisplayLanguage";
const qcc::String LanguageDisplayInterface::s_prop_SupportedDisplayLanguages = "SupportedDisplayLanguages";
