...
QStatus DeviceTypeDescription::AddDeviceType(DeviceType type, const String& objectPath)
{
...
const DeviceTypeDescription::DescriptionsType& DeviceTypeDescription::GetDescriptions() const
{
