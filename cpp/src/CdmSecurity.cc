...
{
    // The file name will be the name of the application.
    return m_bus.EnablePeerSecurity(ECDHE_KEYX, m_authListener.get(), nullptr, false, m_permListener.get());
}
