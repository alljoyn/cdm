...
typedef Ref<OvenCyclePhaseIntfControllerListener> MyInterfaceListener;


class OvenCyclePhaseIntfController::Impl : public InterfaceController
{
  public:

    Impl(
        OvenCyclePhaseIntfController& outer,
    ...
    // The outer facet
    OvenCyclePhaseIntfController& m_outer;
...
QStatus OvenCyclePhaseIntfController::Impl::Init()
{
...
QStatus OvenCyclePhaseIntfController::Impl::GetCyclePhase(void* context)
{
    auto status = m_proxyObject->GetPropertyAsync(GetInterfaceName(), s_prop_CyclePhase.c_str(), this,
                (ProxyBusObject::Listener::GetPropertyCB)&OvenCyclePhaseIntfController::Impl::GetCyclePhasePropertyCB, context);
    return status;
}

QStatus OvenCyclePhaseIntfController::Impl::GetSupportedCyclePhases(void* context)
{
    auto status = m_proxyObject->GetPropertyAsync(GetInterfaceName(), s_prop_SupportedCyclePhases.c_str(), this,
                (ProxyBusObject::Listener::GetPropertyCB)&OvenCyclePhaseIntfController::Impl::GetSupportedCyclePhasesPropertyCB, context);
    return status;
}



QStatus OvenCyclePhaseIntfController::Impl::GetVendorPhasesDescription(const qcc::String& languageTag, void* context)
{
    // Method call
    ...
    auto status = m_proxyObject->MethodCallAsync(GetInterfaceName(), s_method_GetVendorPhasesDescription.c_str(), this,
                (MessageReceiver::ReplyHandler)&OvenCyclePhaseIntfController::Impl::GetVendorPhasesDescriptionReplyHandler,
...
void OvenCyclePhaseIntfController::Impl::PropertiesChanged(ProxyBusObject& obj, const char* ifaceName, const MsgArg& changed, const MsgArg& invalidated, void* context)
{
    MsgArg* entries;
    size_t numEntries;
...
void OvenCyclePhaseIntfController::Impl::GetCyclePhasePropertyCB(QStatus status, ProxyBusObject* obj, const MsgArg& value, void* context)
{
    if (obj) {
        uint8_t val;
        {
...
void OvenCyclePhaseIntfController::Impl::GetSupportedCyclePhasesPropertyCB(QStatus status, ProxyBusObject* obj, const MsgArg& value, void* context)
{
    if (obj) {
        std::vector<uint8_t> val;
        {
...
void OvenCyclePhaseIntfController::Impl::GetVendorPhasesDescriptionReplyHandler(Message& message, void* context)
{
    ...
    if (message->GetType() == MESSAGE_METHOD_RET) {
        ...
        CdmMsgCvt<std::vector<OvenCyclePhaseInterface::CyclePhaseDescriptor>> cvt_phasesDescription;
...
OvenCyclePhaseIntfController::OvenCyclePhaseIntfController(
    BusAttachment& busAttachment,
    Ref<InterfaceControllerListener> listener,
    Ref<ProxyBusObject> cdmProxyObject
    )
  : m_impl(new Impl(*this, busAttachment, dynamic_pointer_cast<OvenCyclePhaseIntfControllerListener>(listener), cdmProxyObject))
{
}
...
Ref<CdmInterface> OvenCyclePhaseIntfController::CreateInterface(BusAttachment& busAttachment, Ref<InterfaceControllerListener> listener, Ref<ProxyBusObject> cdmProxyObject)
{
    return mkRef<OvenCyclePhaseIntfController>(busAttachment, dynamic_pointer_cast<OvenCyclePhaseIntfControllerListener>(listener), cdmProxyObject);
}



QStatus OvenCyclePhaseIntfController::Init()
{
...
BusAttachment& OvenCyclePhaseIntfController::GetBusAttachment() const
{
...
QStatus OvenCyclePhaseIntfController::GetCyclePhase(void* context)
{
...
QStatus OvenCyclePhaseIntfController::GetSupportedCyclePhases(void* context)
{
...
QStatus OvenCyclePhaseIntfController::GetVendorPhasesDescription(const qcc::String& languageTag, void* context)
{
