...
class AudioVideoInputIntfController::Impl : public InterfaceController
{
  public:
    ...
    QStatus SetInputSourceId(const uint16_t value, void* context);
...
QStatus AudioVideoInputIntfController::Impl::SetInputSourceId(const uint16_t value, void* context)
{
    MsgArg arg;
    {
...
QStatus AudioVideoInputIntfController::SetInputSourceId(const uint16_t value, void* context)
{
