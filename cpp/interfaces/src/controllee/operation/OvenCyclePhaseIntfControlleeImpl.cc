    ...
    public OvenCyclePhaseInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<OvenCyclePhaseIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<OvenCyclePhaseIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
OvenCyclePhaseIntfControllee::OvenCyclePhaseIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<OvenCyclePhaseIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    OvenCyclePhaseIntfControllee::Impl* interface = new OvenCyclePhaseIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
OvenCyclePhaseIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<OvenCyclePhaseIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
    InterfaceReceiver(cdmBusObject),
    m_busAttachment(busAttachment),
    m_cdmControllee(cdmControllee),
    m_methodHandlers(),
    m_OvenCyclePhaseModelInterface(model),
    InterfaceName(OvenCyclePhaseInterface::INTERFACE_NAME)
{
...
void OvenCyclePhaseIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
void OvenCyclePhaseIntfControllee::Impl::OnGetVendorPhasesDescription(const InterfaceDescription::Member* member, Message& msg) {
    ...
    auto status = m_OvenCyclePhaseModelInterface->GetVendorPhasesDescription(arg_languageTag, arg_phasesDescription, errorCode, m_cdmControllee);
