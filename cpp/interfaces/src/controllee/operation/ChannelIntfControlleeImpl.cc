    ...
    public ChannelInterface
{
  ...
  public:
     ...
     */
    void OnGetChannelList(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee);
...
void ChannelIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
...
void ChannelIntfControllee::Impl::OnGetChannelList(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee) {
    ...
    auto status = m_ChannelModelInterface->GetChannelList(arg_startingRecord, arg_numRecords, arg_listOfChannelInfoRecords, errorCode, controllee);
