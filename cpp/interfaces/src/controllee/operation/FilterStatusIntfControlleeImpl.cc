    ...
    public FilterStatusInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<FilterStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<FilterStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
FilterStatusIntfControllee::FilterStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<FilterStatusIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    FilterStatusIntfControllee::Impl* interface = new FilterStatusIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
FilterStatusIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<FilterStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
void FilterStatusIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
