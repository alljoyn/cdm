    ...
    public TimerInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<TimerIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<TimerIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
TimerIntfControllee::TimerIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<TimerIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    TimerIntfControllee::Impl* interface = new TimerIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
TimerIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<TimerIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
    InterfaceReceiver(cdmBusObject),
    m_busAttachment(busAttachment),
    m_cdmControllee(cdmControllee),
    m_methodHandlers(),
    m_TimerModelInterface(model),
    InterfaceName(TimerInterface::INTERFACE_NAME)
{
...
void TimerIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
void TimerIntfControllee::Impl::OnSetTargetTimeToStart(const InterfaceDescription::Member* member, Message& msg) {
    ...
    auto status = m_TimerModelInterface->SetTargetTimeToStart(arg_targetTimeToStart, errorCode, m_cdmControllee);
...
void TimerIntfControllee::Impl::OnSetTargetTimeToStop(const InterfaceDescription::Member* member, Message& msg) {
    const MsgArg* args = NULL;
    size_t numArgs = 0;
    ...
    ErrorCode errorCode = NOT_ERROR;
    auto status = m_TimerModelInterface->SetTargetTimeToStop(arg_targetTimeToStop, errorCode, m_cdmControllee);
