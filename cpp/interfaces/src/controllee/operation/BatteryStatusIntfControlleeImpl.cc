    ...
    public BatteryStatusInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<BatteryStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<BatteryStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
BatteryStatusIntfControllee::BatteryStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<BatteryStatusIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    BatteryStatusIntfControllee::Impl* interface = new BatteryStatusIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
BatteryStatusIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<BatteryStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
void BatteryStatusIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
