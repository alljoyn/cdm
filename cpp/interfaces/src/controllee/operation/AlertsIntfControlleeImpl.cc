    ...
    public AlertsInterface
{
  ...
  public:
     ...
     */
    void OnGetAlertCodesDescription(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee);
     ...
     * @param msg reference of alljoyn Message
     */
    void OnAcknowledgeAlert(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee);
     ...
     * @param msg reference of alljoyn Message
     */
    void OnAcknowledgeAllAlerts(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee);
...
void AlertsIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
...
void AlertsIntfControllee::Impl::OnGetAlertCodesDescription(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee) {
    ...
    auto status = m_AlertsModelInterface->GetAlertCodesDescription(arg_languageTag, arg_description, errorCode, controllee);
...
void AlertsIntfControllee::Impl::OnAcknowledgeAlert(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee) {
    const MsgArg* args = NULL;
    size_t numArgs = 0;
    ...
    ErrorCode errorCode = NOT_ERROR;
    auto status = m_AlertsModelInterface->AcknowledgeAlert(arg_alertCode, errorCode, controllee);
...
void AlertsIntfControllee::Impl::OnAcknowledgeAllAlerts(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee) {
    const MsgArg* args = NULL;
    size_t numArgs = 0;
    ...
    ErrorCode errorCode = NOT_ERROR;
    auto status = m_AlertsModelInterface->AcknowledgeAllAlerts(errorCode, controllee);
