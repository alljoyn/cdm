    ...
    public ClosedStatusInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<ClosedStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<ClosedStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
ClosedStatusIntfControllee::ClosedStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<ClosedStatusIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    ClosedStatusIntfControllee::Impl* interface = new ClosedStatusIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
ClosedStatusIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<ClosedStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
QStatus ClosedStatusIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_IsClosed.compare(propName))) {
            bool value;
            auto status = m_ClosedStatusModelInterface->GetIsClosed(value);
            if (status != ER_OK) {
...
void ClosedStatusIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
