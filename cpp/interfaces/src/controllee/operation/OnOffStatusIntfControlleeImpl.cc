    ...
    public OnOffStatusInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<OnOffStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<OnOffStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
OnOffStatusIntfControllee::OnOffStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<OnOffStatusIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    OnOffStatusIntfControllee::Impl* interface = new OnOffStatusIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
OnOffStatusIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<OnOffStatusIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
QStatus OnOffStatusIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    ...
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_IsOn.compare(propName))) {
            bool value;
            status = m_OnOffStatusModelInterface->GetIsOn(value);
            if (status != ER_OK) {
...
void OnOffStatusIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmSideEffects& sideEffects)
{
