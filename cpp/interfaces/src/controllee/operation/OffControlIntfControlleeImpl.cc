    ...
    public OffControlInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<OffControlIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<OffControlIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
OffControlIntfControllee::OffControlIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<OffControlIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    OffControlIntfControllee::Impl* interface = new OffControlIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
OffControlIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<OffControlIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
    InterfaceReceiver(cdmBusObject),
    m_busAttachment(busAttachment),
    m_cdmControllee(cdmControllee),
    m_methodHandlers(),
    m_OffControlModelInterface(model),
    InterfaceName(OffControlInterface::INTERFACE_NAME)
{
...
void OffControlIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
void OffControlIntfControllee::Impl::OnSwitchOff(const InterfaceDescription::Member* member, Message& msg) {
    ...
    auto status = m_OffControlModelInterface->SwitchOff(errorCode, m_cdmControllee);
