    ...
    public CurrentPowerInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<CurrentPowerIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<CurrentPowerIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
CurrentPowerIntfControllee::CurrentPowerIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<CurrentPowerIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    CurrentPowerIntfControllee::Impl* interface = new CurrentPowerIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
CurrentPowerIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<CurrentPowerIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
void CurrentPowerIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
