    ...
    public RepeatModeInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<RepeatModeIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<RepeatModeIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
RepeatModeIntfControllee::RepeatModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<RepeatModeIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    RepeatModeIntfControllee::Impl* interface = new RepeatModeIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
RepeatModeIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<RepeatModeIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
QStatus RepeatModeIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_RepeatMode.compare(propName))) {
            bool value;
            auto status = m_RepeatModeModelInterface->GetRepeatMode(value);
            if (status != ER_OK) {
...
QStatus RepeatModeIntfControllee::Impl::OnSetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_RepeatMode.compare(propName))) {
        ...
        QStatus status = m_RepeatModeModelInterface->SetRepeatMode(validValue);
        if (status != ER_OK) {
...
void RepeatModeIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
