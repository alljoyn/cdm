    ...
    public CycleControlInterface
{
  ...
  public:
     ...
     */
    void OnExecuteOperationalCommand(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee);
...
void CycleControlIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
...
void CycleControlIntfControllee::Impl::OnExecuteOperationalCommand(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee) {
    ...
    auto status = m_CycleControlModelInterface->ExecuteOperationalCommand(arg_command, errorCode, controllee);
