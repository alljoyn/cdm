    ...
    public OnControlInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<OnControlIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<OnControlIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
OnControlIntfControllee::OnControlIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<OnControlIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    OnControlIntfControllee::Impl* interface = new OnControlIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
OnControlIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<OnControlIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
    InterfaceReceiver(cdmBusObject),
    m_busAttachment(busAttachment),
    m_cdmControllee(cdmControllee),
    m_methodHandlers(),
    m_OnControlModelInterface(model),
    InterfaceName(OnControlInterface::INTERFACE_NAME)
{
...
void OnControlIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
void OnControlIntfControllee::Impl::OnSwitchOn(const InterfaceDescription::Member* member, Message& msg) {
    ...
    auto status = m_OnControlModelInterface->SwitchOn(errorCode, m_cdmControllee);
