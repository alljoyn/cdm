    ...
    public OnControlInterface
{
  ...
  public:
     ...
     */
    void OnSwitchOn(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee);
...
void OnControlIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
...
void OnControlIntfControllee::Impl::OnSwitchOn(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee) {
    ...
    auto status = m_OnControlModelInterface->SwitchOn(errorCode, controllee);
