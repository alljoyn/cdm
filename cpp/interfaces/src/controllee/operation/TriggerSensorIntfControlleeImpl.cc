    ...
    public TriggerSensorInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<TriggerSensorIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<TriggerSensorIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
TriggerSensorIntfControllee::TriggerSensorIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<TriggerSensorIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    TriggerSensorIntfControllee::Impl* interface = new TriggerSensorIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
TriggerSensorIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<TriggerSensorIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
void TriggerSensorIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
