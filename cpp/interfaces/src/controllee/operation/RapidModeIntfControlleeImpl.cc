    ...
    public RapidModeInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<RapidModeIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<RapidModeIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
RapidModeIntfControllee::RapidModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<RapidModeIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    RapidModeIntfControllee::Impl* interface = new RapidModeIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
RapidModeIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<RapidModeIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
QStatus RapidModeIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    ...
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_RapidMode.compare(propName))) {
            bool value;
            status = m_RapidModeModelInterface->GetRapidMode(value);
            if (status != ER_OK) {
...
void RapidModeIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmSideEffects& sideEffects)
{
