 ...
 */
class AirRecirculationModeIntfControllee::Impl :
    public InterfaceReceiver,
    public AirRecirculationModeInterface
{

  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<AirRecirculationModeIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
    /**
     * Constructor of AirRecirculationModeIntfControllee::Impl
     */
    Impl(BusAttachment& busAttachment, Ref<AirRecirculationModeIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
AirRecirculationModeIntfControllee::AirRecirculationModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<AirRecirculationModeIntfControlleeModel>(model), cdmBusObject))
{}


AirRecirculationModeIntfControllee::~AirRecirculationModeIntfControllee()
{
    delete m_impl;
}

const qcc::String& AirRecirculationModeIntfControllee::GetInterfaceName() const
{
    return m_impl->GetInterfaceName();
}

QStatus AirRecirculationModeIntfControllee::EmitIsRecirculatingChanged(const bool newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitIsRecirculatingChanged(newValue);
}
 ...
 * Implementation
 */
 AirRecirculationModeIntfControllee::Impl* AirRecirculationModeIntfControllee::Impl::CreateInterface(
    BusAttachment& busAttachment,
    Ref<AirRecirculationModeIntfControlleeModel> model,
    CdmBusObject& cdmBusObject)
{
    AirRecirculationModeIntfControllee::Impl* interface = new AirRecirculationModeIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
AirRecirculationModeIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<AirRecirculationModeIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
QStatus AirRecirculationModeIntfControllee::Impl::Init()
{
...
QStatus AirRecirculationModeIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    QStatus status;
    ...
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_IsRecirculating.compare(propName))) {
            bool value;
            status = m_AirRecirculationModeModelInterface->GetIsRecirculating(value);
            if (status != ER_OK) {
...
QStatus AirRecirculationModeIntfControllee::Impl::OnSetProperty(const String& propName, MsgArg& msgarg)
{
    QStatus status;
    ...
    if (!(s_prop_IsRecirculating.compare(propName))) {
        ...
        EmitIsRecirculatingChanged(value);
...
void AirRecirculationModeIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmSideEffects& sideEffects)
{
...
QStatus AirRecirculationModeIntfControllee::Impl::EmitIsRecirculatingChanged(const bool newValue)
{
    QStatus status = ER_OK;
