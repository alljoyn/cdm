    ...
    public AirRecirculationModeInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<AirRecirculationModeIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<AirRecirculationModeIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
AirRecirculationModeIntfControllee::AirRecirculationModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<AirRecirculationModeIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    AirRecirculationModeIntfControllee::Impl* interface = new AirRecirculationModeIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
AirRecirculationModeIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<AirRecirculationModeIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
QStatus AirRecirculationModeIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_IsRecirculating.compare(propName))) {
            bool value;
            auto status = m_AirRecirculationModeModelInterface->GetIsRecirculating(value);
            if (status != ER_OK) {
...
QStatus AirRecirculationModeIntfControllee::Impl::OnSetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_IsRecirculating.compare(propName))) {
        ...
        QStatus status = m_AirRecirculationModeModelInterface->SetIsRecirculating(validValue);
        if (status != ER_OK) {
...
void AirRecirculationModeIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
