    ...
    public EnergyUsageInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<EnergyUsageIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<EnergyUsageIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
EnergyUsageIntfControllee::EnergyUsageIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<EnergyUsageIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    EnergyUsageIntfControllee::Impl* interface = new EnergyUsageIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
EnergyUsageIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<EnergyUsageIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
    InterfaceReceiver(cdmBusObject),
    m_busAttachment(busAttachment),
    m_cdmControllee(cdmControllee),
    m_methodHandlers(),
    m_EnergyUsageModelInterface(model),
    InterfaceName(EnergyUsageInterface::INTERFACE_NAME)
{
...
void EnergyUsageIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
void EnergyUsageIntfControllee::Impl::OnResetCumulativeEnergy(const InterfaceDescription::Member* member, Message& msg) {
    ...
    auto status = m_EnergyUsageModelInterface->ResetCumulativeEnergy(errorCode, m_cdmControllee);
