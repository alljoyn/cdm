    ...
    public CurrentTemperatureInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<CurrentTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<CurrentTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
CurrentTemperatureIntfControllee::CurrentTemperatureIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<CurrentTemperatureIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    CurrentTemperatureIntfControllee::Impl* interface = new CurrentTemperatureIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
CurrentTemperatureIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<CurrentTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
void CurrentTemperatureIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
