    ...
    public CurrentAirQualityInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<CurrentAirQualityIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<CurrentAirQualityIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
CurrentAirQualityIntfControllee::CurrentAirQualityIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<CurrentAirQualityIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    CurrentAirQualityIntfControllee::Impl* interface = new CurrentAirQualityIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
CurrentAirQualityIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<CurrentAirQualityIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
void CurrentAirQualityIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
