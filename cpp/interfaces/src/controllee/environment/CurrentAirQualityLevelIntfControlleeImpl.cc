    ...
    public CurrentAirQualityLevelInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<CurrentAirQualityLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<CurrentAirQualityLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
CurrentAirQualityLevelIntfControllee::CurrentAirQualityLevelIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<CurrentAirQualityLevelIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}
...
{
    CurrentAirQualityLevelIntfControllee::Impl* interface = new CurrentAirQualityLevelIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
CurrentAirQualityLevelIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<CurrentAirQualityLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
void CurrentAirQualityLevelIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
