    ...
    public TargetTemperatureLevelInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<TargetTemperatureLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<TargetTemperatureLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
TargetTemperatureLevelIntfControllee::TargetTemperatureLevelIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<TargetTemperatureLevelIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    TargetTemperatureLevelIntfControllee::Impl* interface = new TargetTemperatureLevelIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
TargetTemperatureLevelIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<TargetTemperatureLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
void TargetTemperatureLevelIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
