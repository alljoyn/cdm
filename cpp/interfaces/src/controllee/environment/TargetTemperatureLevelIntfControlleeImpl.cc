 ...
 */
class TargetTemperatureLevelIntfControllee::Impl :
    public InterfaceReceiver,
    public TargetTemperatureLevelInterface
{

  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<TargetTemperatureLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
    /**
     * Constructor of TargetTemperatureLevelIntfControllee::Impl
     */
    Impl(BusAttachment& busAttachment, Ref<TargetTemperatureLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
    ...
    Ref<TargetTemperatureLevelIntfControlleeModel> m_TargetTemperatureLevelModelInterface;
 ...
 * Forwarding
 */
TargetTemperatureLevelIntfControllee::TargetTemperatureLevelIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<TargetTemperatureLevelIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}


TargetTemperatureLevelIntfControllee::~TargetTemperatureLevelIntfControllee()
{
    delete m_impl;
}

const qcc::String& TargetTemperatureLevelIntfControllee::GetInterfaceName() const
{
    return m_impl->GetInterfaceName();
}

QStatus TargetTemperatureLevelIntfControllee::EmitMaxLevelChanged(const uint8_t newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitMaxLevelChanged(newValue);
}

QStatus TargetTemperatureLevelIntfControllee::EmitTargetLevelChanged(const uint8_t newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitTargetLevelChanged(newValue);
}

QStatus TargetTemperatureLevelIntfControllee::EmitSelectableTemperatureLevelsChanged(const std::vector<uint8_t>& newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitSelectableTemperatureLevelsChanged(newValue);
}
 ...
 * Implementation
 */
 TargetTemperatureLevelIntfControllee::Impl* TargetTemperatureLevelIntfControllee::Impl::CreateInterface(
    BusAttachment& busAttachment,
    Ref<TargetTemperatureLevelIntfControlleeModel> model,
    CdmBusObject& cdmBusObject,
    CdmControllee& cdmControllee)
{
    TargetTemperatureLevelIntfControllee::Impl* interface = new TargetTemperatureLevelIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
TargetTemperatureLevelIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<TargetTemperatureLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
    InterfaceReceiver(cdmBusObject),
    m_busAttachment(busAttachment),
    m_cdmControllee(cdmControllee),
    m_methodHandlers(),
    m_TargetTemperatureLevelModelInterface(model),
    InterfaceName(TargetTemperatureLevelInterface::INTERFACE_NAME)
{
    ignore_unused(m_cdmControllee);
}


QStatus TargetTemperatureLevelIntfControllee::Impl::Init()
{
...
QStatus TargetTemperatureLevelIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_MaxLevel.compare(propName))) {
            uint8_t value;
            auto status = m_TargetTemperatureLevelModelInterface->GetMaxLevel(value);
            if (status != ER_OK) {
            ...
            uint8_t value;
            auto status = m_TargetTemperatureLevelModelInterface->GetTargetLevel(value);
            if (status != ER_OK) {
                QCC_LogError(status, ("%s: failed to get actual property value from application. use previous value.", __func__));
                return ER_FAIL;
            }
            ...
            auto status = m_TargetTemperatureLevelModelInterface->GetSelectableTemperatureLevels(value);
            if (status != ER_OK) {
                QCC_LogError(status, ("%s: failed to get actual property value from application. use previous value.", __func__));
                return ER_FAIL;
            }
...
QStatus TargetTemperatureLevelIntfControllee::Impl::OnSetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_MaxLevel.compare(propName))) {
        ...
        QStatus status = m_TargetTemperatureLevelModelInterface->SetTargetLevel(validValue);
        if (status != ER_OK) {
...
void TargetTemperatureLevelIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
QStatus TargetTemperatureLevelIntfControllee::Impl::EmitMaxLevelChanged(const uint8_t newValue)
{
...
QStatus TargetTemperatureLevelIntfControllee::Impl::EmitTargetLevelChanged(const uint8_t newValue)
{
    QStatus status = ER_OK;
...
QStatus TargetTemperatureLevelIntfControllee::Impl::EmitSelectableTemperatureLevelsChanged(const std::vector<uint8_t>& newValue)
{
    QStatus status = ER_OK;
...
QStatus TargetTemperatureLevelIntfControllee::Impl::ValidateTargetLevel(uint8_t value)
{

    std::vector<uint8_t> validValues;
    if (m_TargetTemperatureLevelModelInterface->GetSelectableTemperatureLevels(validValues) != ER_OK)
        return ER_FAIL;
