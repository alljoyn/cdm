    ...
    public WaterLevelInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<WaterLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<WaterLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
WaterLevelIntfControllee::WaterLevelIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<WaterLevelIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    WaterLevelIntfControllee::Impl* interface = new WaterLevelIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
WaterLevelIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<WaterLevelIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
void WaterLevelIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
