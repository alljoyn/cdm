    ...
    public CurrentHumidityInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<CurrentHumidityIntfControlleeModel> model, CdmBusObject& cdmBusObject);
  ...
  private:
     ...
     */
    Impl(BusAttachment& busAttachment, Ref<CurrentHumidityIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
CurrentHumidityIntfControllee::CurrentHumidityIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<CurrentHumidityIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    CurrentHumidityIntfControllee::Impl* interface = new CurrentHumidityIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
CurrentHumidityIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<CurrentHumidityIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
void CurrentHumidityIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
