 ...
 */
class TargetTemperatureIntfControllee::Impl :
    public InterfaceReceiver,
    public TargetTemperatureInterface
{

  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<TargetTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
  ...
  private:
    /**
     * Constructor of TargetTemperatureIntfControllee::Impl
     */
    Impl(BusAttachment& busAttachment, Ref<TargetTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
 ...
 * Forwarding
 */
TargetTemperatureIntfControllee::TargetTemperatureIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<TargetTemperatureIntfControlleeModel>(model), cdmBusObject, cdmControllee))
{}


TargetTemperatureIntfControllee::~TargetTemperatureIntfControllee()
{
    delete m_impl;
}

const qcc::String& TargetTemperatureIntfControllee::GetInterfaceName() const
{
    return m_impl->GetInterfaceName();
}

QStatus TargetTemperatureIntfControllee::EmitTargetValueChanged(const double newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitTargetValueChanged(newValue);
}

QStatus TargetTemperatureIntfControllee::EmitMinValueChanged(const double newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitMinValueChanged(newValue);
}

QStatus TargetTemperatureIntfControllee::EmitMaxValueChanged(const double newValue)
{
    return (m_impl == nullptr) ? ER_FAIL : m_impl->EmitMaxValueChanged(newValue);
}

QStatus TargetTemperatureIntfControllee::EmitStepValueChanged(const double newValue)
{
 ...
 * Implementation
 */
 TargetTemperatureIntfControllee::Impl* TargetTemperatureIntfControllee::Impl::CreateInterface(
    BusAttachment& busAttachment,
    Ref<TargetTemperatureIntfControlleeModel> model,
    CdmBusObject& cdmBusObject,
    CdmControllee& cdmControllee)
{
    TargetTemperatureIntfControllee::Impl* interface = new TargetTemperatureIntfControllee::Impl(busAttachment, model, cdmBusObject, cdmControllee);
...
TargetTemperatureIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<TargetTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee) :
...
QStatus TargetTemperatureIntfControllee::Impl::Init()
{
...
QStatus TargetTemperatureIntfControllee::Impl::OnGetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_Version.compare(propName))) {
        ...
        if (!(s_prop_TargetValue.compare(propName))) {
            double value;
            auto status = m_TargetTemperatureModelInterface->GetTargetValue(value);
            if (status != ER_OK) {
            ...
            double value;
            auto status = m_TargetTemperatureModelInterface->GetMinValue(value);
            if (status != ER_OK) {
                QCC_LogError(status, ("%s: failed to get actual property value from application. use previous value.", __func__));
                return ER_FAIL;
            }
            ...
            double value;
            auto status = m_TargetTemperatureModelInterface->GetMaxValue(value);
            if (status != ER_OK) {
                QCC_LogError(status, ("%s: failed to get actual property value from application. use previous value.", __func__));
                return ER_FAIL;
            }
            ...
            double value;
            auto status = m_TargetTemperatureModelInterface->GetStepValue(value);
            if (status != ER_OK) {
                QCC_LogError(status, ("%s: failed to get actual property value from application. use previous value.", __func__));
                return ER_FAIL;
            }
...
QStatus TargetTemperatureIntfControllee::Impl::OnSetProperty(const String& propName, MsgArg& msgarg)
{
    if (!(s_prop_TargetValue.compare(propName))) {
...
void TargetTemperatureIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg)
{
    bool isFound = false;
...
QStatus TargetTemperatureIntfControllee::Impl::EmitTargetValueChanged(const double newValue)
{
...
QStatus TargetTemperatureIntfControllee::Impl::EmitMinValueChanged(const double newValue)
{
    QStatus status = ER_OK;
...
QStatus TargetTemperatureIntfControllee::Impl::EmitMaxValueChanged(const double newValue)
{
    QStatus status = ER_OK;
...
QStatus TargetTemperatureIntfControllee::Impl::EmitStepValueChanged(const double newValue)
{
    QStatus status = ER_OK;
...
QStatus TargetTemperatureIntfControllee::Impl::clampTargetValue(double value, double& out)
{
    ...
    double minValue;
    if (m_TargetTemperatureModelInterface->GetMinValue(minValue) != ER_OK)
        return ER_FAIL;

    double maxValue;
    if (m_TargetTemperatureModelInterface->GetMaxValue(maxValue) != ER_OK)
        return ER_FAIL;

    double stepValue = 0;
    if (m_TargetTemperatureModelInterface->GetStepValue(stepValue) != ER_OK)
        return ER_FAIL;
