    ...
    public TargetTemperatureInterface
{
  ...
  public:
    static Impl* CreateInterface(BusAttachment& busAttachment, Ref<TargetTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject);
 ...
 * Forwarding
 */
TargetTemperatureIntfControllee::TargetTemperatureIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject)
    : m_impl(Impl::CreateInterface(busAttachment, dynamic_pointer_cast<TargetTemperatureIntfControlleeModel>(model), cdmBusObject))
{}
...
{
    TargetTemperatureIntfControllee::Impl* interface = new TargetTemperatureIntfControllee::Impl(busAttachment, model, cdmBusObject);
...
TargetTemperatureIntfControllee::Impl::Impl(BusAttachment& busAttachment, Ref<TargetTemperatureIntfControlleeModel> model, CdmBusObject& cdmBusObject) :
...
void TargetTemperatureIntfControllee::Impl::OnMethodHandler(const InterfaceDescription::Member* member, Message& msg, CdmControllee& controllee)
{
    bool isFound = false;
