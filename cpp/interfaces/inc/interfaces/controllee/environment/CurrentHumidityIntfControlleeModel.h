...
/**
 * CurrentHumidity Model Interface class for the Controllee
 */
class CurrentHumidityIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:

    /**
     * Destructor of CurrentHumidityIntfControlleeModel
     */
    virtual ~CurrentHumidityIntfControlleeModel() {}
