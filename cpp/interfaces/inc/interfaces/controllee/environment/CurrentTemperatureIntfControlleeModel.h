...
/**
 * CurrentTemperature Model Interface class for the Controllee
 */
class CurrentTemperatureIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:

    /**
     * Destructor of CurrentTemperatureIntfControlleeModel
     */
    virtual ~CurrentTemperatureIntfControlleeModel() {}
