...
/**
 * CurrentAirQualityLevel Model Interface class for the Controllee
 */
class CurrentAirQualityLevelIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    using ContaminantType = CurrentAirQualityLevelInterface::ContaminantType;

    /**
     * Destructor of CurrentAirQualityLevelIntfControlleeModel
     */
    virtual ~CurrentAirQualityLevelIntfControlleeModel() {}

    /**
     * Get ContaminantType
     * @return current contaminant type
     */
    virtual QStatus GetContaminantType(CurrentAirQualityLevelInterface::ContaminantType& out) const = 0;
    /**
     * Get CurrentLevel
     * @return current current level
     */
    virtual QStatus GetCurrentLevel(uint8_t& out) const = 0;
    /**
     * Get MaxLevel
