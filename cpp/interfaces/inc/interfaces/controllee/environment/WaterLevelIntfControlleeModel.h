...
/**
 * WaterLevel Model Interface class for the Controllee
 */
class WaterLevelIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    using SupplySource = WaterLevelInterface::SupplySource;

    /**
     * Destructor of WaterLevelIntfControlleeModel
     */
    virtual ~WaterLevelIntfControlleeModel() {}

    /**
     * Get SupplySource
     * @return current supply source
     */
    virtual QStatus GetSupplySource(WaterLevelInterface::SupplySource& out) const = 0;
    /**
     * Get CurrentLevel
