...
/**
 * AudioVideoInput Model Interface class for the Controllee
 */
class AudioVideoInputIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    ...
    /**
     * Destructor of AudioVideoInputIntfControlleeModel
     */
    virtual ~AudioVideoInputIntfControlleeModel() {}

    /**
     * Get InputSourceId
     * @return current input source id
     */
    virtual QStatus GetInputSourceId(SourceType& out) const = 0;
     ...
     */
    virtual QStatus SetInputSourceId(const SourceType value) = 0;
    /**
     * Get SupportedInputSources
     * @return current supported input sources
     */
    virtual QStatus GetSupportedInputSources(std::vector<InputSource>& out) const = 0;
