 ...
 */
class BatteryStatusIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    BatteryStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
