...
/**
 * SoilLevel Model Interface class for the Controllee
 */
class SoilLevelIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:

    /**
     * Destructor of SoilLevelIntfControlleeModel
     */
    virtual ~SoilLevelIntfControlleeModel() {}
