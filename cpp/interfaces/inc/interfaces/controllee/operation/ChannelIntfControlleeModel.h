...
class ChannelIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetChannelList(uint16_t arg_startingRecord, uint16_t arg_numRecords, std::vector<ChannelInterface::ChannelInfoRecord>& arg_listOfChannelInfoRecords, ErrorCode& error, CdmControllee& controllee) = 0;
};
