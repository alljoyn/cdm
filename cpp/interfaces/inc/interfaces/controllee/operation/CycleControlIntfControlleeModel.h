...
class CycleControlIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
     ...
     */
    virtual QStatus GetOperationalState(CycleControlInterface::OperationalState& out) const = 0;
    /**
     * Get SupportedOperationalStates
     * @return current supported operational states
     */
    virtual QStatus GetSupportedOperationalStates(std::vector<CycleControlInterface::OperationalState>& out) const = 0;
    /**
     * Get SupportedOperationalCommands
     * @return current supported operational commands
     */
    virtual QStatus GetSupportedOperationalCommands(std::vector<CycleControlInterface::OperationalCommands>& out) const = 0;
     ...
     */
    virtual QStatus ExecuteOperationalCommand(CycleControlInterface::OperationalCommands arg_command, ErrorCode& error, CdmControllee& controllee) = 0;
};
