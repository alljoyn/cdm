 ...
 */
class RepeatModeIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    RepeatModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
