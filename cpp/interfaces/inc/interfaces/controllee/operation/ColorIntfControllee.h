...
#ifndef COLORINTFCONTROLLEE_H_
#define COLORINTFCONTROLLEE_H_
...
/**
 * Color Interface Controllee class
 */
class ColorIntfControllee final : public CdmControlleeInterface
{
  public:

    /**
     * Constructor of ColorIntfControllee
     */
    ColorIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);

    /**
     * Destructor of ColorIntfControllee
     */
    ~ColorIntfControllee();
