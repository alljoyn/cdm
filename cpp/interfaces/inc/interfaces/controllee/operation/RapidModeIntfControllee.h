 ...
 */
class RapidModeIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    RapidModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
