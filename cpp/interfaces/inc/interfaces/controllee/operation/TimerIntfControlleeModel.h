...
class TimerIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
     ...
     */
    virtual QStatus SetTargetTimeToStart(int32_t arg_targetTimeToStart, ErrorCode& error, CdmControllee& controllee) = 0;
    /**
     * Handler for method SetTargetTimeToStop
     * @param[out] error Internal error code occurred during command execution
     * @return ER_OK on success
     */
    virtual QStatus SetTargetTimeToStop(int32_t arg_targetTimeToStop, ErrorCode& error, CdmControllee& controllee) = 0;
};
