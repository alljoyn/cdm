...
class HvacFanModeIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
     ...
     * @return current mode
     */
    virtual QStatus GetMode(HvacFanModeInterface::Mode& out) const = 0;
     ...
     */
    virtual QStatus SetMode(const HvacFanModeInterface::Mode value) = 0;
    /**
     * Get SupportedModes
     * @return current supported modes
     */
    virtual QStatus GetSupportedModes(std::vector<HvacFanModeInterface::Mode>& out) const = 0;
