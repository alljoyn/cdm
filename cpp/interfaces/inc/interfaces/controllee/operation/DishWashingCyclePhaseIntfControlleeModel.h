...
class DishWashingCyclePhaseIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
     ...
     */
    virtual QStatus GetVendorPhasesDescription(qcc::String& arg_languageTag, std::vector<DishWashingCyclePhaseInterface::CyclePhaseDescriptor>& arg_phasesDescription, ErrorCode& error, CdmControllee& controllee) = 0;
};
