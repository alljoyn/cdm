...
/**
 * DishWashingCyclePhase Model Interface class for the Controllee
 */
class DishWashingCyclePhaseIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    using CyclePhaseDescriptor = DishWashingCyclePhaseInterface::CyclePhaseDescriptor;

    /**
     * Destructor of DishWashingCyclePhaseIntfControlleeModel
     */
    virtual ~DishWashingCyclePhaseIntfControlleeModel() {}
