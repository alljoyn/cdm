 ...
 */
class RapidModeTimedIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    RapidModeTimedIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
