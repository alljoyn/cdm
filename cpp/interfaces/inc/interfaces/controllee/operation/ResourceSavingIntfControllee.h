 ...
 */
class ResourceSavingIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    ResourceSavingIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
