 ...
 */
class EnergyUsageIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    EnergyUsageIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
