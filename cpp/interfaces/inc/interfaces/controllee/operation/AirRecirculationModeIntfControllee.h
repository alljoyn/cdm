...
class AirRecirculationModeIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    AirRecirculationModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
