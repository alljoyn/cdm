 ...
 */
class ClosedStatusIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    ClosedStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
