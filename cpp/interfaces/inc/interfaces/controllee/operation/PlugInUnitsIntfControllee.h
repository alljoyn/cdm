 ...
 */
class PlugInUnitsIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    PlugInUnitsIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
