 ...
 */
class OvenCyclePhaseIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    OvenCyclePhaseIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
