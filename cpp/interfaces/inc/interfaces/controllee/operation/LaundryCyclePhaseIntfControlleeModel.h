...
/**
 * LaundryCyclePhase Model Interface class for the Controllee
 */
class LaundryCyclePhaseIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    using CyclePhaseDescriptor = LaundryCyclePhaseInterface::CyclePhaseDescriptor;

    /**
     * Destructor of LaundryCyclePhaseIntfControlleeModel
     */
    virtual ~LaundryCyclePhaseIntfControlleeModel() {}
