 ...
 */
class ChannelIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    ChannelIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
