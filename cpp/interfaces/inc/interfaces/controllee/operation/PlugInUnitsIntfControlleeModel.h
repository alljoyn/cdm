...
/**
 * PlugInUnits Model Interface class for the Controllee
 */
class PlugInUnitsIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    using PlugInInfo = PlugInUnitsInterface::PlugInInfo;

    /**
     * Destructor of PlugInUnitsIntfControlleeModel
     */
    virtual ~PlugInUnitsIntfControlleeModel() {}

    /**
     * Get PlugInUnits
     * @return current plug in units
     */
    virtual QStatus GetPlugInUnits(std::vector<PlugInInfo>& out) const = 0;
