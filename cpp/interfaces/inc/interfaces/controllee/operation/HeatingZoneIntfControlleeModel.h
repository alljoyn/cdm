...
/**
 * HeatingZone Model Interface class for the Controllee
 */
class HeatingZoneIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:

    /**
     * Destructor of HeatingZoneIntfControlleeModel
     */
    virtual ~HeatingZoneIntfControlleeModel() {}

    /**
     * Get NumberOfHeatingZones
     * @return current number of heating zones
     */
    virtual QStatus GetNumberOfHeatingZones(uint8_t& out) const = 0;
    /**
     * Get MaxHeatingLevels
     * @return current max heating levels
     */
    virtual QStatus GetMaxHeatingLevels(std::vector<uint8_t>& out) const = 0;
    /**
     * Get HeatingLevels
     * @return current heating levels
     */
    virtual QStatus GetHeatingLevels(std::vector<uint8_t>& out) const = 0;
