 ...
 */
class HvacFanModeIntfControllee final : public CdmControlleeInterface
{
  public:
    using Mode = HvacFanModeInterface::Mode;

    /**
     * Constructor of HvacFanModeIntfControllee
     */
    HvacFanModeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);

    /**
     * Destructor of HvacFanModeIntfControllee
     */
