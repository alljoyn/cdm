...
/**
 * OnOffStatus Model Interface class for the Controllee
 */
class OnOffStatusIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:

    /**
     * Destructor of OnOffStatusIntfControlleeModel
     */
    virtual ~OnOffStatusIntfControlleeModel() {}

    /**
     * Get IsOn
     * @return current is on
     */
    virtual QStatus GetIsOn(bool& out) const = 0;
