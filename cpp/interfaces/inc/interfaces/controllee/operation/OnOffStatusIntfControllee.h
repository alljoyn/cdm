 ...
 */
class OnOffStatusIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    OnOffStatusIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
