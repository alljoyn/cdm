 ...
 */
class AudioVolumeIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    AudioVolumeIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
