...
class DishWashingCyclePhaseIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    DishWashingCyclePhaseIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
