...
/**
 * RepeatMode Model Interface class for the Controllee
 */
class RepeatModeIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:

    /**
     * Destructor of RepeatModeIntfControlleeModel
     */
    virtual ~RepeatModeIntfControlleeModel() {}

    /**
     * Get RepeatMode
     * @return current repeat mode
     */
    virtual QStatus GetRepeatMode(bool& out) const = 0;
