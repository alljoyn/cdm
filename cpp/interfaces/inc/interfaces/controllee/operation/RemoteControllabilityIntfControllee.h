 ...
 */
class RemoteControllabilityIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    RemoteControllabilityIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
