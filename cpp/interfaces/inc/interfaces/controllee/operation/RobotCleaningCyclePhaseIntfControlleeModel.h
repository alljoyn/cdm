...
class RobotCleaningCyclePhaseIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
     ...
     */
    virtual QStatus GetVendorPhasesDescription(qcc::String& arg_languageTag, std::vector<RobotCleaningCyclePhaseInterface::CyclePhaseDescriptor>& arg_phasesDescription, ErrorCode& error, CdmControllee& controllee) = 0;
};
