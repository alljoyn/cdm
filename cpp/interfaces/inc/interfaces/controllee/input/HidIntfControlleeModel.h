...
/**
 * Hid Model Interface class for the Controllee
 */
class HidIntfControlleeModel : public virtual InterfaceControlleeModel {
  public:
    using InputEvent = HidInterface::InputEvent;
    using SupportedInputEvent = HidInterface::SupportedInputEvent;

    /**
     * Destructor of HidIntfControlleeModel
     */
    virtual ~HidIntfControlleeModel() {}

    /**
     * Get SupportedEvents
     * @return current supported events
     */
    virtual QStatus GetSupportedEvents(std::vector<HidInterface::SupportedInputEvent>& out) const = 0;
     ...
     */
    virtual QStatus InjectEvents(std::vector<HidInterface::InputEvent>& arg_inputEvents, ErrorCode& error, CdmControllee& controllee) = 0;
};
