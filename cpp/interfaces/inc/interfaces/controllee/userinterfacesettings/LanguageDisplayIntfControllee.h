 ...
 */
class LanguageDisplayIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    LanguageDisplayIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
