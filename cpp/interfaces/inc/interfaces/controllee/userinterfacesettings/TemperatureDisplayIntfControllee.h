 ...
 */
class TemperatureDisplayIntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    TemperatureDisplayIntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject, CdmControllee& cdmControllee);
