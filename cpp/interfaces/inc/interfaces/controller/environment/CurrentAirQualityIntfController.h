...
class CurrentAirQualityIntfController : public CurrentAirQualityInterface {
  public:
     ...
     */
    virtual QStatus GetContaminantType(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetCurrentValue(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetPrecision(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetUpdateMinTime(void* context = NULL);
