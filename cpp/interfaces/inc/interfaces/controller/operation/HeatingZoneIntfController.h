...
class HeatingZoneIntfController : public HeatingZoneInterface {
  public:
     ...
     */
    virtual QStatus GetNumberOfHeatingZones(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetMaxHeatingLevels(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetHeatingLevels(void* context = NULL);
