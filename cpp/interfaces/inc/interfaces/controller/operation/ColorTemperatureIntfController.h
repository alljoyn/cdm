...
class ColorTemperatureIntfController : public ColorTemperatureInterface {
  public:
     ...
     */
    virtual QStatus GetTemperature(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetTemperature(const double value, void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetMinTemperature(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetMaxTemperature(void* context = NULL);
