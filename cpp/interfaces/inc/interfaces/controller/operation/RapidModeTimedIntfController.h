...
class RapidModeTimedIntfController : public RapidModeTimedInterface {
  public:
     ...
     */
    virtual QStatus GetRapidModeMinutesRemaining(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetRapidModeMinutesRemaining(const uint16_t value, void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetMaxSetMinutes(void* context = NULL);
