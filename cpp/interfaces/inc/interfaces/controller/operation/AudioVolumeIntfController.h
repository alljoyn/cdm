...
class AudioVolumeIntfController : public AudioVolumeInterface {
  public:
     ...
     */
    virtual QStatus GetVolume(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetVolume(const uint8_t value, void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetMaxVolume(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetMute(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetMute(const bool value, void* context = NULL);
