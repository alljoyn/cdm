...
class ChannelIntfController : public ChannelInterface {
  public:
     ...
     */
    virtual QStatus GetChannelId(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetChannelId(const qcc::String& value, void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetTotalNumberOfChannels(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetChannelList(const uint16_t startingRecord, const uint16_t numRecords, void* context = NULL);
