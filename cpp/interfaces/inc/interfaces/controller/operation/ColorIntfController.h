...
class ColorIntfController : public ColorInterface {
  public:
     ...
     */
    virtual QStatus GetHue(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetHue(const double value, void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus GetSaturation(void* context = NULL);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetSaturation(const double value, void* context = NULL);
