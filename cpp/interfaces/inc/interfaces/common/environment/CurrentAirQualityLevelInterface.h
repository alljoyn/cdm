...
template<>
struct CdmMsgCvt<CurrentAirQualityLevelInterface::ContaminantType>
{
    void get(const MsgArg& msgarg, CurrentAirQualityLevelInterface::ContaminantType& value)
    {
        int32_t v;
        msgarg.Get("i", &v);
        value = static_cast<CurrentAirQualityLevelInterface::ContaminantType>(v);
    }

    void set(MsgArg& msgarg, CurrentAirQualityLevelInterface::ContaminantType value)
    {
...
template<>
struct CdmMsgCvt<std::vector<CurrentAirQualityLevelInterface::ContaminantType>>
{
    void get(const MsgArg& msgarg, std::vector<CurrentAirQualityLevelInterface::ContaminantType>& value)
    {
        int32_t* v;
        size_t l;
        ...
        {
            value[i] = static_cast<CurrentAirQualityLevelInterface::ContaminantType>(v[i]);
        }
    }

    void set(MsgArg& msgarg, const std::vector<CurrentAirQualityLevelInterface::ContaminantType>& value)
    {
        size_t l = value.size();
