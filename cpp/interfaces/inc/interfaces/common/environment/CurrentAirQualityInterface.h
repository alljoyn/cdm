...
template<>
struct CdmMsgCvt<CurrentAirQualityInterface::ContaminantType>
{
    ...
    void set(MsgArg& msgarg, CurrentAirQualityInterface::ContaminantType value)
    {
...
template<>
struct CdmMsgCvt<std::vector<CurrentAirQualityInterface::ContaminantType>>
{
    void get(const MsgArg& msgarg, std::vector<CurrentAirQualityInterface::ContaminantType>& value)
    {
        ...
        {
            value[i] = static_cast<CurrentAirQualityInterface::ContaminantType>(v[i]);
        }
    }

    void set(MsgArg& msgarg, const std::vector<CurrentAirQualityInterface::ContaminantType>& value)
    {
        size_t l = value.size();
