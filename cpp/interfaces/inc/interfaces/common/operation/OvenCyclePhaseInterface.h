...
struct CdmMsgCvt<OvenCyclePhaseInterface::CyclePhaseDescriptor>
{
    ...
    void set(MsgArg& msgarg, OvenCyclePhaseInterface::CyclePhaseDescriptor value)
    {
...
struct CdmMsgCvt<std::vector<OvenCyclePhaseInterface::CyclePhaseDescriptor>>
{
    ...
    void set(MsgArg& msgarg, std::vector<OvenCyclePhaseInterface::CyclePhaseDescriptor>& value)
    {
