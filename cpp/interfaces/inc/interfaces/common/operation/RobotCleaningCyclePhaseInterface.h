...
struct CdmMsgCvt<RobotCleaningCyclePhaseInterface::CyclePhaseDescriptor>
{
    ...
    void set(MsgArg& msgarg, RobotCleaningCyclePhaseInterface::CyclePhaseDescriptor value)
    {
...
struct CdmMsgCvt<std::vector<RobotCleaningCyclePhaseInterface::CyclePhaseDescriptor>>
{
    ...
    void set(MsgArg& msgarg, std::vector<RobotCleaningCyclePhaseInterface::CyclePhaseDescriptor>& value)
    {
