...
template<>
struct CdmMsgCvt<HvacFanModeInterface::Mode>
{
    ...
    void set(MsgArg& msgarg, HvacFanModeInterface::Mode value)
    {
...
template<>
struct CdmMsgCvt<std::vector<HvacFanModeInterface::Mode>>
{
    void get(const MsgArg& msgarg, std::vector<HvacFanModeInterface::Mode>& value)
    {
        ...
        {
            value[i] = static_cast<HvacFanModeInterface::Mode>(v[i]);
        }
    }

    void set(MsgArg& msgarg, const std::vector<HvacFanModeInterface::Mode>& value)
    {
        size_t l = value.size();
