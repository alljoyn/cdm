...
struct CdmMsgCvt<LaundryCyclePhaseInterface::CyclePhaseDescriptor>
{
    ...
    void set(MsgArg& msgarg, const LaundryCyclePhaseInterface::CyclePhaseDescriptor value)
    {
    ...
    {
        LaundryCyclePhaseInterface::CyclePhaseDescriptor value;
        get(msgarg, value);
...
struct CdmMsgCvt<std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>>
{
    ...
    void set(MsgArg& msgarg, const std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>& value)
    {
    ...
    std::string str(const MsgArg& msgarg)
    {
        std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor> vec;
        get(msgarg, vec);
