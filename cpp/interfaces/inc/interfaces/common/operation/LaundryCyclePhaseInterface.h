...
// Struct converters
template<>
struct CdmMsgCvt<LaundryCyclePhaseInterface::CyclePhaseDescriptor>
{
    void get(const MsgArg& msgarg, LaundryCyclePhaseInterface::CyclePhaseDescriptor& value)
    {
        msgarg.Get("(yss)", &value.phase, &value.name, &value.description);
    }

    void set(MsgArg& msgarg, LaundryCyclePhaseInterface::CyclePhaseDescriptor value)
    {
...
template<>
struct CdmMsgCvt<std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>>
{
    void get(const MsgArg& msgarg, std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>& value)
    {
        MsgArg* elems;
        size_t  num;
    ...
    void set(MsgArg& msgarg, std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>& value)
    {
