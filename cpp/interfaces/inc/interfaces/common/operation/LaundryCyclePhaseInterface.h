...
{
    void get(const MsgArg& msgarg, LaundryCyclePhaseInterface::CyclePhaseDescriptor& arg_)
    {
        uint8_t field_phase{};
    ...
    void set(MsgArg& msgarg, const LaundryCyclePhaseInterface::CyclePhaseDescriptor arg_)
    {
    ...
    {
        LaundryCyclePhaseInterface::CyclePhaseDescriptor arg_;
        get(msgarg, arg_);
...
{
    void get(const MsgArg& msgarg, std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>& arg_)
    {
        MsgArg* elems = 0;
        size_t  num = 0;
    ...
    void set(MsgArg& msgarg, const std::vector<LaundryCyclePhaseInterface::CyclePhaseDescriptor>& arg_)
    {
