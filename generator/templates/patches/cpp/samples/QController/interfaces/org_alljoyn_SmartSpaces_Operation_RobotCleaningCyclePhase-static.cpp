...
org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang::org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang(QWidget* parent, const QString& lang)
{
    lang_ = lang;
...
org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang::~org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang()
{
    delete dialog_;
}
...
int org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang::run()
{
...
void org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang::changed()
{
...
{
    auto* dialog = new org_alljoyn_SmartSpaces_Operation_RobotCleaningCyclePhase_GetLang(parent, lang);
