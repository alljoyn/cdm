 ...
 */
class {{Interface.Name}}IntfControlleeModel : public virtual InterfaceControlleeListener {
  public:
     ...
     * @return ER_OK on success
     */
    virtual QStatus {{method.Name}}({# TODO: support method arguments! #}ErrorCode& error) = 0;
    {% endfor %}
};
