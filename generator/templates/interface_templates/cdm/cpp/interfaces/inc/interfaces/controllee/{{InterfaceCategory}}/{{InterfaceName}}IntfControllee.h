 ...
 */
class {{Interface.Name}}IntfControllee final : public CdmControlleeInterface
{
  public:
     ...
     */
    {{Interface.Name}}IntfControllee(BusAttachment& busAttachment, Ref<InterfaceControlleeModel> model, CdmBusObject& cdmBusObject);
