...
package org.alljoyn.cdmcontroller.fragment.{{Interface.Category}};
...
public class {{Interface.Name}}Fragment extends InterfaceFragment {
    ...
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        ...
        View {{method.Name.camel_case()}}View = new MethodView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "{{method.Name}}"{% for arg in method.input_args() %}, "{{arg.Name.camel_case()}}"{% endfor %});
