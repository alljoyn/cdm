...
import org.alljoyn.smartspaces.operation.CurrentPower;
...
public class CurrentPowerFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.CurrentPower";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View currentPowerView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "CurrentPower", null);
