...
import org.alljoyn.smartspaces.operation.LockControl;
...
public class LockControlFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.LockControl";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View lockView = new MethodView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "Lock");
        methods.addView(lockView);
