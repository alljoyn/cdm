...
import org.alljoyn.smartspaces.operation.ColorTemperature;
...
public class ColorTemperatureFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.ColorTemperature";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View temperatureView = new ReadWriteValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "Temperature", null);
        properties.addView(temperatureView);

        View minTemperatureView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "MinTemperature", null);
        properties.addView(minTemperatureView);

        View maxTemperatureView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "MaxTemperature", null);
        properties.addView(maxTemperatureView);
