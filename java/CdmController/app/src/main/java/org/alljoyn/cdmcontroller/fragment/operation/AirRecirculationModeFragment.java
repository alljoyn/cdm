...
import org.alljoyn.smartspaces.operation.AirRecirculationMode;
...
public class AirRecirculationModeFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.AirRecirculationMode";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View isRecirculatingView = new ReadWriteValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "IsRecirculating", null);
        properties.addView(isRecirculatingView);
