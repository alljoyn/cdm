...
import org.alljoyn.smartspaces.operation.BatteryStatus;
...
public class BatteryStatusFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.BatteryStatus";
    ...
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        ...
        View isChargingView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "IsCharging", null);
