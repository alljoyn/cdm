...
import org.alljoyn.smartspaces.operation.PlugInUnits;
...
public class PlugInUnitsFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.PlugInUnits";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View plugInUnitsView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "PlugInUnits", null);
        properties.addView(plugInUnitsView);
