...
import org.alljoyn.smartspaces.operation.OnControl;
...
public class OnControlFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.OnControl";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View switchOnView = new MethodView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "SwitchOn");
        methods.addView(switchOnView);
