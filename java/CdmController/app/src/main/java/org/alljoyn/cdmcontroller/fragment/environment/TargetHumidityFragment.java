...
public class TargetHumidityFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Environment.TargetHumidity";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View targetValueView = new MinMaxPropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "TargetValue", "%", "MinValue", "MaxValue", "StepValue");
