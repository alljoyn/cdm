...
import org.alljoyn.smartspaces.operation.LockedStatus;
...
public class LockedStatusFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.LockedStatus";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View isLockedView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "IsLocked", null);
        properties.addView(isLockedView);
