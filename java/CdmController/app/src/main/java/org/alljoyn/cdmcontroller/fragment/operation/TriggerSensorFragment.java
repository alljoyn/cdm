...
import org.alljoyn.smartspaces.operation.TriggerSensor;
...
public class TriggerSensorFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.TriggerSensor";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View currentlyTriggeredView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "CurrentlyTriggered", null);
        properties.addView(currentlyTriggeredView);
