...
import org.alljoyn.smartspaces.operation.UnlockControl;
...
public class UnlockControlFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.UnlockControl";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View unlockView = new MethodView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "Unlock");
        methods.addView(unlockView);
