...
import org.alljoyn.smartspaces.operation.OffControl;
...
public class OffControlFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.OffControl";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View switchOffView = new MethodView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "SwitchOff");
        methods.addView(switchOffView);
