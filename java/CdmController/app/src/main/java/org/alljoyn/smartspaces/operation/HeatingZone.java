...
@BusInterface(name="org.alljoyn.SmartSpaces.Operation.HeatingZone", descriptionLanguage="en")
@Secure
public interface HeatingZone {
    ...
    public byte getNumberOfHeatingZones();

    @BusProperty(annotation=BusProperty.ANNOTATE_EMIT_CHANGED_SIGNAL, signature="ay")
    public byte[] getMaxHeatingLevels();

    @BusProperty(annotation=BusProperty.ANNOTATE_EMIT_CHANGED_SIGNAL, signature="ay")
    public byte[] getHeatingLevels();
