...
import org.alljoyn.smartspaces.operation.Brightness;
...
public class BrightnessFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.Brightness";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View brightnessView = new ReadWriteValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "Brightness", null);
        properties.addView(brightnessView);
