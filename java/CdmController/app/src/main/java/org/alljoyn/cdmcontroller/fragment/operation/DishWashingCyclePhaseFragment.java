...
public class DishWashingCyclePhaseFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.DishWashingCyclePhase";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View cyclePhaseView = new SupportedVendorValuesAndEnumPropertyView(
                getActivity(), this.device, this.objPath,
                INTERFACE_NAME, "CyclePhase", null,
                1, 0, "SupportedCyclePhases",
                DishWashingCyclePhase.CyclePhase.class, "GetVendorPhasesDescription", "en");
