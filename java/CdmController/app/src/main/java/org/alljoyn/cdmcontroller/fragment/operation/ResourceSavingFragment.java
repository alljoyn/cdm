...
import org.alljoyn.smartspaces.operation.ResourceSaving;
...
public class ResourceSavingFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.ResourceSaving";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View resourceSavingModeView = new ReadWriteValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "ResourceSavingMode", null);
        properties.addView(resourceSavingModeView);
