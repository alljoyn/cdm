...
public class TargetTemperatureFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Environment.TargetTemperature";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View targetValueView = new ReadWriteValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "TargetValue", null);
        ...
        View stepValueView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "StepValue", null);
        properties.addView(stepValueView);
