...
public class LanguageDisplayActivity extends InterfaceActivity {
    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {

        View languageView = new SupportedValuesPropertyView(this, this.intf, "DisplayLanguage", null, "SupportedDisplayLanguages");
        properties.addView(languageView);
