...
import org.alljoyn.smartspaces.operation.RepeatMode;
...
public class RepeatModeFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.RepeatMode";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View repeatModeView = new ReadWriteValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "RepeatMode", null);
        properties.addView(repeatModeView);
