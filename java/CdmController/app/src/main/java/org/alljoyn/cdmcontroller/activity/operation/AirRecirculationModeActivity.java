...
public class AirRecirculationModeActivity extends InterfaceActivity {
    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View isRecirculatingView = new ReadWriteBoolPropertyView(this, this.intf, "IsRecirculating");
