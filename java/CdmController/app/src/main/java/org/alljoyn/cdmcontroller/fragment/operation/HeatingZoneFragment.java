...
import org.alljoyn.smartspaces.operation.HeatingZone;
...
public class HeatingZoneFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.HeatingZone";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View heatingZonesView = new ListWithSubValuesPropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "NumberOfHeatingZones", "HeatingZone", null, "MaxHeatingLevels", "HeatingLevels");
        properties.addView(heatingZonesView);
    }
