...
import org.alljoyn.smartspaces.operation.EnergyUsage;
...
public class EnergyUsageFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.EnergyUsage";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View cumulativeEnergyView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "CumulativeEnergy", null);
        ...
        View resetCumulativeEnergyView = new MethodView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "ResetCumulativeEnergy");
