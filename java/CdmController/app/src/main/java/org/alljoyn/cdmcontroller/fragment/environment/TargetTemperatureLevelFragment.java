...
import org.alljoyn.smartspaces.environment.TargetTemperatureLevel;
...
public class TargetTemperatureLevelFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Environment.TargetTemperatureLevel";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View targetValueView = new SupportedValuesPropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "TargetLevel", null, "SelectableTemperatureLevels");
