...
public class RemoteControllabilityFragment extends InterfaceFragment {
    private static final String INTERFACE_NAME = "org.alljoyn.SmartSpaces.Operation.RemoteControllability";

    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View isControllableView = new ReadOnlyValuePropertyView(getActivity(), this.device, this.objPath, INTERFACE_NAME, "IsControllable", null);
        properties.addView(isControllableView);
