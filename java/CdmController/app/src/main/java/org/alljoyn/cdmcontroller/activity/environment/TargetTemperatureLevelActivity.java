...
public class TargetTemperatureLevelActivity extends InterfaceActivity {
    @Override
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View targetValueView = new SupportedValuesPropertyView(this, this.intf, "TargetLevel", null, "SelectableTemperatureLevels");
