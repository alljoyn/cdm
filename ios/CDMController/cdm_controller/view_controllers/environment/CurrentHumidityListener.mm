...
CurrentHumidityListener::CurrentHumidityListener(CurrentHumidityViewController *viewController):viewController(viewController)
{
...
void CurrentHumidityListener::UpdateCurrentValue(const uint8_t value)
{
...
void CurrentHumidityListener::UpdateMaxValue(const uint8_t value)
{
    NSString *valueAsStr = [NSString stringWithFormat:@"%u", value];
