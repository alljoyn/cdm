...
#ifndef TargetHumidityViewController_h
#define TargetHumidityViewController_h
...
@interface TargetHumidityViewController : InterfaceViewController <ReadWriteValueDelegate>
...
@property (nonatomic, strong) ReadOnlyValuePropertyCell *selectableHumidityLevelsCell;

- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController;

@end

#endif /* TargetHumidityViewController_h */