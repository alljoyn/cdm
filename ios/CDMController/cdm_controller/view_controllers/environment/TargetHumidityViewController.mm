...
#import "interfaces/controller/environment/TargetHumidityIntfController.h"
...
@property std::shared_ptr<TargetHumidityListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<TargetHumidityListener>(new TargetHumidityListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::TARGET_HUMIDITY_INTERFACE),
