...
{
    public:
        WaterLevelListener(WaterLevelViewController *viewController);
    ...
    private:
        WaterLevelViewController *viewController;
};

#endif /* WaterLevelListener_h */
