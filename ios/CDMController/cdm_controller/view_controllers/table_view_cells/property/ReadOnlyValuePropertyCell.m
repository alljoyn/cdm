...
@interface ReadOnlyValuePropertyCell()

@end


@implementation ReadOnlyValuePropertyCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.value = [[UITextView alloc] initWithFrame:CGRectMake(self.frame.size.width-90, 12.5, 75, 25)];
        self.value.text = @"unknown";
        self.value.textAlignment = NSTextAlignmentCenter;
        self.value.font = [UIFont systemFontOfSize:14];
        self.value.editable = NO;
        self.value.selectable = NO;
