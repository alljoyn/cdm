...
{
    public:
        HvacFanModeListener(HvacFanModeViewController *viewController);
    ...
    private:
        HvacFanModeViewController *viewController;
};

#endif /* HvacFanModeListener_h */