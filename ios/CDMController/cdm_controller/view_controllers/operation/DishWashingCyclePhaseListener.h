...
#ifndef DishWashingCyclePhaseListener_h
...
{
    public:
        DishWashingCyclePhaseListener(DishWashingCyclePhaseViewController *viewController);
    ...
    private:
        DishWashingCyclePhaseViewController *viewController;
};

#endif /* DishWashingCyclePhaseListener_h */
