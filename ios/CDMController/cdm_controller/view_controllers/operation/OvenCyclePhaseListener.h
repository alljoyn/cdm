...
#ifndef OvenCyclePhaseListener_h
...
{
    public:
        OvenCyclePhaseListener(OvenCyclePhaseViewController *viewController);
    ...
    private:
        OvenCyclePhaseViewController *viewController;
};

#endif /* OvenCyclePhaseListener_h */