...
#import "interfaces/controller/operation/RepeatModeIntfController.h"
...
@property std::shared_ptr<RepeatModeListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<RepeatModeListener>(new RepeatModeListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::REPEAT_MODE_INTERFACE),
