...
{
    public:
        OnOffStatusListener(OnOffStatusViewController *viewController);
    
        virtual ~OnOffStatusListener();

        virtual void UpdateIsOn(const bool value);
    ...
    private:
        OnOffStatusViewController *viewController;
};

#endif /* OnOffStatusListener_h */