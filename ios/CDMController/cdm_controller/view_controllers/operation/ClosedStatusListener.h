...
{
    public:
        ClosedStatusListener(ClosedStatusViewController *viewController);
    
        virtual ~ClosedStatusListener();

        virtual void UpdateIsClosed(const bool value);
    ...
    private:
        ClosedStatusViewController *viewController;
};

#endif /* ClosedStatusListener_h */