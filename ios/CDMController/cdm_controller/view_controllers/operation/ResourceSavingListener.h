...
#ifndef ResourceSavingListener_h
...
{
    public:
        ResourceSavingListener(ResourceSavingViewController *viewController);
    
        virtual ~ResourceSavingListener();

        virtual void UpdateResourceSavingMode(const bool value);
    ...
    private:
        ResourceSavingViewController *viewController;
};

#endif /* ResourceSavingListener_h */