...
#ifndef LaundryCyclePhaseListener_h
...
{
    public:
        LaundryCyclePhaseListener(LaundryCyclePhaseViewController *viewController);
    ...
    private:
        LaundryCyclePhaseViewController *viewController;
};

#endif /* LaundryCyclePhaseListener_h */
