...
#import "alljoyn/cdm/interfaces/operation/AudioVolumeIntfController.h"
...
@property AudioVolumeListener *listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = new AudioVolumeListener(self);

        _cdmInterface = _cdmController->CreateInterface(ajn::services::AUDIO_VOLUME_INTERFACE,
