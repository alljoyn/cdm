...
#import "interfaces/controller/operation/OnControlIntfController.h"
...
@property std::shared_ptr<OnControlListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<OnControlListener>(new OnControlListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::ON_CONTROL_INTERFACE),
