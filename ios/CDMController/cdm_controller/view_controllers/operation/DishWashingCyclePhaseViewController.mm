...
#import "interfaces/controller/operation/DishWashingCyclePhaseIntfController.h"

static NSInteger NUM_MEMBER_CATEGORIES = 3;
static NSInteger NUM_PROPERTIES = 2;
static NSInteger NUM_METHODS = 1;

@interface DishWashingCyclePhaseViewController() 
@property ajn::services::CdmController *cdmController;
@property (nonatomic, strong) Device* device;
@property std::shared_ptr<DishWashingCyclePhaseListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<DishWashingCyclePhaseListener>(new DishWashingCyclePhaseListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::DISH_WASHING_CYCLE_PHASE_INTERFACE),
