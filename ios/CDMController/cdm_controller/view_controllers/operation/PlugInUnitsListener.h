...
{
    public:
        PlugInUnitsListener(PlugInUnitsViewController *viewController);
    ...
    private:
        PlugInUnitsViewController *viewController;
};

#endif /* PlugInUnitsListener_h */