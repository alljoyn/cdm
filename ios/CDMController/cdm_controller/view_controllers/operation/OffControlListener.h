...
{
    public:
        OffControlListener(OffControlViewController *viewController);
    ...
    private:
        OffControlViewController *viewController;
};

#endif /* OffControlListener_h */
