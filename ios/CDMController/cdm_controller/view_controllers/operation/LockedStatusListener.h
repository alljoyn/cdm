...
{
    public:
        LockedStatusListener(LockedStatusViewController *viewController);
    
        virtual ~LockedStatusListener();

        virtual void UpdateIsLocked(const bool value);
    ...
    private:
        LockedStatusViewController *viewController;
};

#endif /* LockedStatusListener_h */
