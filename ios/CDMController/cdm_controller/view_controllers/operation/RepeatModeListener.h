...
{
    public:
        RepeatModeListener(RepeatModeViewController *viewController);
    
        virtual ~RepeatModeListener();

        virtual void UpdateRepeatMode(const bool value);
    ...
    private:
        RepeatModeViewController *viewController;
};

#endif /* RepeatModeListener_h */
