...
#import "interfaces/controller/operation/RobotCleaningCyclePhaseIntfController.h"

static NSInteger NUM_MEMBER_CATEGORIES = 3;
static NSInteger NUM_PROPERTIES = 2;
static NSInteger NUM_METHODS = 1;

@interface RobotCleaningCyclePhaseViewController() 
@property ajn::services::CdmController *cdmController;
@property (nonatomic, strong) Device* device;
@property std::shared_ptr<RobotCleaningCyclePhaseListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<RobotCleaningCyclePhaseListener>(new RobotCleaningCyclePhaseListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::ROBOT_CLEANING_CYCLE_PHASE_INTERFACE),
