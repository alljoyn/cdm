...
#ifndef RemoteControllabilityListener_h
...
{
    public:
        RemoteControllabilityListener(RemoteControllabilityViewController *viewController);
    
        virtual ~RemoteControllabilityListener();

        virtual void UpdateIsControllable(const bool value);
    ...
    private:
        RemoteControllabilityViewController *viewController;
};

#endif /* RemoteControllabilityListener_h */
