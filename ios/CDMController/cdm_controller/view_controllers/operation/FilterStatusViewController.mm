...
#import "interfaces/controller/operation/FilterStatusIntfController.h"
...
@property std::shared_ptr<FilterStatusListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<FilterStatusListener>(new FilterStatusListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::FILTER_STATUS_INTERFACE),
