...
#import "interfaces/controller/operation/PlugInUnitsIntfController.h"
...
@property std::shared_ptr<PlugInUnitsListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<PlugInUnitsListener>(new PlugInUnitsListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::PLUG_IN_UNITS_INTERFACE),
