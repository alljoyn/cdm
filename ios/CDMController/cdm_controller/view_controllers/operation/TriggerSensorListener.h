...
#ifndef TriggerSensorListener_h
...
{
    public:
        TriggerSensorListener(TriggerSensorViewController *viewController);
    
        virtual ~TriggerSensorListener();

        virtual void UpdateCurrentlyTriggered(const bool value);
    ...
    private:
        TriggerSensorViewController *viewController;
};

#endif /* TriggerSensorListener_h */
