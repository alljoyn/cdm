...
PlugInUnitsListener::PlugInUnitsListener(PlugInUnitsViewController *viewController):viewController(viewController)
{
...
void PlugInUnitsListener::UpdatePlugInUnits(const std::vector<PlugInInfo>& value)
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        viewController.plugInUnitsCell.value.text = [NSString stringWithFormat:@"%@", valueArrayAsString];
    });
}
