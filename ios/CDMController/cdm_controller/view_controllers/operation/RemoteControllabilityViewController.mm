...
#import "interfaces/controller/operation/RemoteControllabilityIntfController.h"
...
@property std::shared_ptr<RemoteControllabilityListener> listener;
...
- (instancetype)initWithDevice:(Device *)device andController:(ajn::services::CdmController *)cdmController
{
    ...
    if (self) {
        ...
        _listener = std::shared_ptr<RemoteControllabilityListener>(new RemoteControllabilityListener(self));

        _cdmInterface = _cdmController->CreateInterface(ajn::services::CdmInterface::GetInterfaceName(ajn::services::REMOTE_CONTROLLABILITY_INTERFACE),
